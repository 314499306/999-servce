...
public class MyBatisGeneratorRun {
    ...
    //数据库连结信息
    private final String dbUrl = "jdbc:mysql://localhost:3306/topic-01?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    private final String driver = "com.mysql.cj.jdbc.Driver";
    private final String userName = "root";
    private final String password = "root";

    //项目名
    private final String projectName = "my-spring-boot";
    //指定包名
    private final String packageName = "com.hollysys.tn";
    //controller基础类
    private final String superControllerClass = packageName + ".common.controller.BaseController";
    //entity基础类
    private final String superEntityClass = packageName + ".common.entity.AbstractEntity";
    //模块名 如果有模块名，则需在模块名前加. 例：.log
    private final String moduleName = "";
    //作者名
    private final String author = "lushanyuan";
    //指定生成的表名
...
//        int index = path.indexOf(projectName);
        return "I:/MyWorkSpace/" + projectName + "/src/main/java/";
    }
    /**
     * 策略配置
     * @param tableNames 表名
